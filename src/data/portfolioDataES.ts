...
export const PROJECT_TEXTS: ProjectText[] = [
  ...
  },
  {
    id: 'proj-4',
    title: 'VINOTECA',
    subtitle: 'Vitrina impulsada por bases de datos',
    description: 'Plataforma de ecommerce simulada centrada en vinos y cervezas.',
    longDescription: 'Vinoteca es un proyecto escolar enfocado en construir una experiencia de tienda completa con frontend, backend, gestión de base de datos y manejo de productos. El proyecto utiliza MongoDB y tecnologías web modernas para simular una tienda en línea real mientras enfatiza organización limpia y estructura mantenible.',
    techStack: ['MongoDB', 'Next.js', 'TypeScript', 'Node.js'],
    metrics: ['Backend con MongoDB', 'Lógica de tienda', 'Operaciones CRUD completas'],
    placeholderText: '[ MARCADOR DE POSICIÓN VINOTECA ]',
  },
  {
    id: 'proj-5',
